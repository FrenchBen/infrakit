...
func sslInitSsl() (*asset, error) {
	...
	info := bindataFileInfo{name: "ssl/init-ssl", size: 1817, mode: os.FileMode(420), modTime: time.Unix(1477939750, 0)}
...
func sslInitSslCa() (*asset, error) {
	...
	info := bindataFileInfo{name: "ssl/init-ssl-ca", size: 691, mode: os.FileMode(420), modTime: time.Unix(1477939750, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
